...
data%>%
  filter(type == "Stroke" & race == "Overall" & sex == "Overall" & age_group == "Ages 35-64 years")%>%
  ggplot(aes(x = data)) +
  geom_histogram(bins = 30, fill = "lightblue") +
  labs(title = "Overall Stroke Mortality Rate vs Number of Counties", subtitle = " for 35-64 year olds per 100,000", x = "Mortality Rate", y = "Number of Counties")+  theme_minimal()
...
data%>%filter(type == "CHD" & race == "Overall" & sex == "Overall" & age_group == "Ages 35-64 years")%>%
  ggplot(aes(x = data)) +
  geom_histogram(bins = 30, fill = "lightblue") + 
  labs(title = "Overall CHD Mortality Rate vs Number of Counties", subtitle = " for 35-64 year olds per 100,000", x = "Mortality Rate", y = "Number of Counties")+
  theme_minimal()
```
