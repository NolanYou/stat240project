...
For further analyzing, we can dig deeper into factors affecting one group having higher average chance of getting disease (Stroke and CHD) by having more data about these cases, making regression to predict the pattern of the average proportion of people getting disease in different regions , etc.
