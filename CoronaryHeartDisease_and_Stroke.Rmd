...
gt(df = 20)+
  ...
  ggtitle("t distribution with degree of freedom = 20")
```
...
- The data might not be continuous (there are a discrete number of people getting diseases).

Based on our data analysis, we can say that there is at least some correlation with all the categories we tested. These include: age, race, and sex. There is very strong evidence that the mean mortality rate of those aged 35 to 64 who died from coronary heart disease is different from the mean of the mortality rate of those aged 65 and older. Also, there is very strong evidence that the mean mortality rate of those aged 35 to 64 who died from stroke is different from the mean of the mortality rate of those aged 65 and older.There is very strong evidence that the mean mortality rate of women who died from coronary heart disease is smaller than the mean of the mortality rate of men from heart disease.Also, there is not evidence to conclude that the mean mortality rate from stroke is different between men and women.There is strong statistically evidence that the mean mortality rate of Non-Hispanic Black people is disproportionately higher than the average of all other races. There is a difference between the groups, and we can see that by its low p value and extreme test statistic. Also, there is strong evidence that the mean mortality rate of Asians is disproportionately lower than the average mortality rate of all other races. There is a difference between the groups, and we can see that by its low p value and extreme test statistic. There are some shortcomings in our project. First, we could use more data to fully test our hypothesis and its connections to other factors. Secondly, we can use the extra data to analyze different groups and see what factors within that group make them more susceptible to CHD and stroke. Other factors we could look at include, if the person smokes, other related medical conditions, and whether or not that disease is hereditary. 
