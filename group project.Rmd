...
t.test(x, y)
```
There is strong evidence that the mean mortality rate of Non-Hispanic Black people is disproportionately higher.There is a difference between the groups, and we can see that by its low p value and extreme test statisic.
